  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Mönchengladbach | David Friseursalon</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon David Friseursalon in Mönchengladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="David Friseursalon | Premium Friseursalon Mönchengladbach" />
        <meta
        ...
        <meta name="twitter:title" content="David Friseursalon | Premium Friseursalon Mönchengladbach" />
        <meta
